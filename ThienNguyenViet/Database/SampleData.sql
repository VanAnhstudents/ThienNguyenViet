...
VALUES
    (1,  N'Admin',              'admin@thiennguyen.vn',             '0192023a7bbd73250516f069df18b500', '0901000001',   NULL,       1,      1,          '2026-01-01'),
    (2,  N'User',             'anhnguyenvan280105@gmail.com',      '8ded46825e5b0a5c34d1c07451bb7474', '0901000002',   NULL,       0,      1,          '2026-01-05')
GO
...
(
    ...
    N'/TaiLen/ChienDich/lu-lut-mien-trung.jpg',
    500000000, 320000000,
...
(
    ...
    N'/TaiLen/ChienDich/hoc-bong-vung-cao.jpg',
    300000000, 185000000,
...
(
    ...
    N'/TaiLen/ChienDich/phau-thuat-tim.jpg',
...
(
    ...
    N'/TaiLen/ChienDich/trong-cay-xanh.jpg',
    150000000, 62000000,
...
(
    ...
    N'/TaiLen/ChienDich/xay-truong-ha-giang.jpg',
    400000000, 400000000,
...
(
    ...
    N'/TaiLen/ChienDich/kham-benh-mien-phi.jpg',
    80000000, 15000000,
...
VALUES
    (1, N'/TaiLen/ChienDich/lu-lut-1.jpg',      N'Nhà dân bị ngập lụt',         1),
    (1, N'/TaiLen/ChienDich/lu-lut-2.jpg',      N'Đoàn cứu trợ tiếp tế',        2),
    (1, N'/TaiLen/ChienDich/lu-lut-3.jpg',      N'Trao quà cho bà con',         3),
    (2, N'/TaiLen/ChienDich/hoc-sinh-1.jpg',    N'Học sinh nhận học bổng',       1),
    (2, N'/TaiLen/ChienDich/hoc-sinh-2.jpg',    N'Lớp học vùng cao',            2),
    (3, N'/TaiLen/ChienDich/tim-1.jpg',         N'Bé được phẫu thuật thành công',1),
    (3, N'/TaiLen/ChienDich/tim-2.jpg',         N'Đội ngũ bác sĩ phẫu thuật',   2)
GO
...
(
    ...
    N'/TaiLen/ChienDich/tienDo-lu-1.jpg',
    1, '2026-03-06'
),
(
    1,
    ...
    N'/TaiLen/ChienDich/tienDo-lu-2.jpg',
    1, '2026-03-15'
),
(
    2,
...
INSERT INTO dbo.DanhMucTinTuc (MaDanhMuc, TenDanhMuc, ThuTuHienThi)
VALUES
...
(1,  1, 2,    500000,     N'Chúc bà con sớm ổn định cuộc sống!',     0, N'/TaiLen/XacNhanChuyenKhoan/ck-001.jpg', 1, 1, '2026-03-02', '2026-03-02'),
(2,  1, 3,    200000,     N'Mong bà con vượt qua khó khăn.',          0, N'/TaiLen/XacNhanChuyenKhoan/ck-002.jpg', 1, 1, '2026-03-03', '2026-03-03'),
(3,  1, NULL, 1000000,    NULL,                                        1, N'/TaiLen/XacNhanChuyenKhoan/ck-003.jpg', 1, 1, '2026-03-04', '2026-03-04'),  -- ẩn danh
(4,  1, 4,    5000000,    N'Một chút tấm lòng gửi đến bà con.',       0, N'/TaiLen/XacNhanChuyenKhoan/ck-004.jpg', 1, 1, '2026-03-05', '2026-03-05'),
(5,  1, 5,    300000,     N'Cố lên bà con miền Trung!',               0, N'/TaiLen/XacNhanChuyenKhoan/ck-005.jpg', 1, 1, '2026-03-06', '2026-03-06'),
(6,  1, 6,    200000,     NULL,                                        0, N'/TaiLen/XacNhanChuyenKhoan/ck-006.jpg', 0, NULL, NULL,         '2026-03-16'),  -- chờ duyệt

-- Chiến dịch 2: Học bổng
(7,  2, 2,    500000,     N'Chúc các em học giỏi!',                   0, N'/TaiLen/XacNhanChuyenKhoan/ck-007.jpg', 1, 1, '2026-02-05', '2026-02-05'),
(8,  2, 7,    2000000,    N'Góp một phần nhỏ vì tương lai các em.',   0, N'/TaiLen/XacNhanChuyenKhoan/ck-008.jpg', 1, 1, '2026-02-10', '2026-02-10'),
(9,  2, NULL, 500000,     NULL,                                        1, N'/TaiLen/XacNhanChuyenKhoan/ck-009.jpg', 1, 1, '2026-02-12', '2026-02-12'),  -- ẩn danh

-- Chiến dịch 3: Tim bẩm sinh
(10, 3, 3,    1000000,    N'Cầu chúc các bé mau khỏe!',              0, N'/TaiLen/XacNhanChuyenKhoan/ck-010.jpg', 1, 1, '2026-01-20', '2026-01-20'),
(11, 3, 4,    500000,     N'Mong các bé sớm bình phục.',              0, N'/TaiLen/XacNhanChuyenKhoan/ck-011.jpg', 1, 1, '2026-01-22', '2026-01-22'),
(12, 3, 2,    300000,     NULL,                                        0, N'/TaiLen/XacNhanChuyenKhoan/ck-012.jpg', 2, 1, '2026-01-25', '2026-01-24'),  -- từ chối (trùng)

-- Chiến dịch 6: Khám bệnh miễn phí
(13, 6, 5,    500000,     N'Chúc chương trình thành công!',           0, N'/TaiLen/XacNhanChuyenKhoan/ck-013.jpg', 1, 1, '2026-03-16', '2026-03-16'),
(14, 6, 7,    200000,     NULL,                                        0, N'/TaiLen/XacNhanChuyenKhoan/ck-014.jpg', 0, NULL, NULL,         '2026-03-17')   -- chờ duyệt
GO
...
SELECT N'NguoiDung'         AS TenBang, COUNT(*) AS SoDong FROM dbo.NguoiDung         UNION ALL
SELECT N'DanhMucChienDich',              COUNT(*)           FROM dbo.DanhMucChienDich  UNION ALL
SELECT N'ChienDich',                     COUNT(*)           FROM dbo.ChienDich         UNION ALL
SELECT N'AnhChienDich',                  COUNT(*)           FROM dbo.AnhChienDich      UNION ALL
SELECT N'CapNhatTienDo',                 COUNT(*)           FROM dbo.CapNhatTienDo     UNION ALL
SELECT N'DanhMucTinTuc',                 COUNT(*)           FROM dbo.DanhMucTinTuc     UNION ALL
SELECT N'TinTuc',                        COUNT(*)           FROM dbo.TinTuc            UNION ALL
SELECT N'QuyenGop',                      COUNT(*)           FROM dbo.QuyenGop          UNION ALL
SELECT N'ThongBao',                      COUNT(*)           FROM dbo.ThongBao
GO

PRINT N'Nhập dữ liệu mẫu ThienNguyenViet thành công!'