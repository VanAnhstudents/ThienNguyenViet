    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .panel-left::before {
            ...
            top: -140px; right: -180px; pointer-events: none;
        }
        .panel-left::after {
            content: '';
        ...
        .glow {
            ...
            top: 35%; right: 5%; pointer-events: none;
        }
        ...
        /* Benefits */
        .benefits { list-style: none; position: relative; z-index: 1; }
        .benefits li {
        ...
        .benefits li .chk {
            ...
            display: flex; align-items: center; justify-content: center;
            font-size: 10px; color: #7EE090; flex-shrink: 0; margin-top: 1px;
        }
        ...
        .form-subtitle {
            font-size: 14px; color: var(--chu-phu); margin-bottom: 20px;
        }
        .form-subtitle a { color: var(--mau-chinh); font-weight: 600; text-decoration: none; }
        ...
        .step {
            ...
            font-size: 12px; font-weight: 600; color: var(--chu-phu);
        }
        .step-dot {
            width: 24px; height: 24px; border-radius: 50%;
            background: #E2E8F0;
            display: flex; align-items: center; justify-content: center;
            font-size: 11px; font-weight: 700; color: var(--chu-phu);
            flex-shrink: 0;
        }
        .step.active .step-dot { background: var(--mau-chinh); color: #fff; }
        .step.active { color: var(--mau-chinh); }
        ...
        .field-hint { font-size: 11px; font-weight: 400; color: var(--chu-phu); }
        ...
        .field-inp.is-ok  { border-color: #38A169; }
        .field-inp.is-err { border-color: #E53E3E; box-shadow: 0 0 0 3px rgba(229,62,62,.1); }
        ...
        /* Strength */
        .pwd-bars { display: flex; gap: 4px; margin-top: 5px; }
        .pwd-bar {
            flex: 1; height: 3px; border-radius: 99px;
            background: #E2E8F0; transition: background .3s;
        }
        .pwd-bar.s-weak   { background: #E53E3E; }
        .pwd-bar.s-medium { background: #D69E2E; }
        .pwd-bar.s-strong { background: #38A169; }
        .pwd-label {
        ...
        .terms-text {
            font-size: 13px; color: var(--chu-than); line-height: 1.55;
        }
        .terms-text a { color: var(--mau-chinh); font-weight: 600; text-decoration: none; }
        ...
        .btn-reg:hover { transform: translateY(-2px); box-shadow: 0 7px 20px rgba(45,122,79,.4); }
        ...
        @media (max-width: 820px) {
            ...
            .panel-hero p, .benefits { display: none; }
    ...
    <div class="auth-wrapper">
        ...
        <div class="panel-left">
            ...
            <div class="panel-hero">
                ...
                <h1>Tr&#7903; th&#224;nh<br/><em>t&#236;nh nguy&#7879;n</em><br/>vi&#234;n h&#244;m nay</h1>
...
<script>
    ...
    function validateRegister() {
        ...
        if (!hoten) return err('Vui lòng nhập họ và tên!');
        if (hoten.length < 2) return err('Họ tên phải có ít nhất 2 ký tự!');
        if (!email || !emailRx.test(email)) return err('Email không hợp lệ!');
        if (!phone || !phoneRx.test(phone)) return err('Số điện thoại không hợp lệ (VD: 09xxxxxxxx)!');
        if (pass.length < 6) return err('Mật khẩu phải có ít nhất 6 ký tự!');
        if (pass !== confirm) return err('Mật khẩu xác nhận không khớp!');
        if (!agree) return err('Bạn phải đồng ý với điều khoản sử dụng!');
        return true;
    }
</script>
</body>
